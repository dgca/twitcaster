...
function UserInfo(_ref) {
  ...
  return React.createElement("div", {
  ...
  }, React.createElement(DropIcon, null)), React.createElement("div", {
    className: "user-name"
  }, React.createElement(Twemoji, {
    options: {
    ...
    className: "fake-link"
  }, config.user.name)), config.user.verified && React.createElement("div", {
    className: "icon"
  }, React.createElement(VerifiedIcon, null)), config.user.locked && !config.user.verified && React.createElement("div", {
    className: "icon"
  }, React.createElement(LockIcon, null))), React.createElement("div", {
    className: "user-nickname"
  }, "@", config.user.nickname)));
}

function useText(rawText) {
  var _useState = useState(rawText),
      text = _useState[0],
      setText = _useState[1];
...
function handleEmoji(key, result) {
  return React.createElement(Twemoji, {
    key: key,
    options: {
...
function ImagesContainer(_ref) {
  ...
  switch (image.length) {
    ...
    case 2:
      ...
      }, React.createElement(OneImageColumn, {
        side: "left",
        image: image[0]
      }), React.createElement("div", {
    ...
    case 3:
      return React.createElement("div", {
        ...
        className: "vertical-spacer"
      }), React.createElement(TwoImagesColumn, {
        side: "right",
        image1: image[1],
        image2: image[2]
      }));
...
function Content(_ref) {
  ...
  return React.createElement("div", {
    ...
    className: "txt"
  }, text), React.createElement(ImagesContainer, {
    config: config
  }));
}
...
function Metadata(_ref) {
  ...
  return React.createElement("div", {
    className: "metadata"
  }, config.date, " \xB7 ", React.createElement("span", {
...
function Impact(_ref) {
  ...
  return React.createElement("div", {
    className: "rt-likes"
  }, config.retweets !== 0 && React.createElement("span", {
    className: "fake-link num-rts"
  }, React.createElement("strong", null, styleNumber(config.retweets)), ' ', getText('Retweet', config.retweets)), config.quotedTweets !== 0 && React.createElement("span", {
    className: "fake-link num-quotes"
  }, React.createElement("strong", null, styleNumber(config.quotedTweets)), ' ', getText('Quoted Tweet', config.quotedTweets)), config.likes !== 0 && React.createElement("span", {
    className: "fake-link num-likes"
  }, React.createElement("strong", null, styleNumber(config.likes)), ' ', getText('Like', config.likes)));
...
function Actions() {
  var actions = [{
    color: 'blue',
    icon: React.createElement(CommentIcon, null)
  }, {
    color: 'green',
    icon: React.createElement(RetweetIcon, null)
  }, {
    color: 'red',
    icon: React.createElement(LikeIcon, null)
  }, {
    color: 'blue',
    icon: React.createElement(ShareIcon, null)
  }];
  return React.createElement("div", {
    ...
    }, React.createElement("div", null, action.icon));
  }));
}
...
//# sourceMappingURL=fake-tweet.esm.js.map
